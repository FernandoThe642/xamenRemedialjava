...
a persistence unit "javaexamen63PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "javaexamen63/pom.xml":
...
artifact ("javaexamen63.war") is already built. You can build
